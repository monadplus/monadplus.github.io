...
description: In this post, we are going to introduce a few uses cases of Template Haskell such as type class instances derivation, n-ary function generation, a quasiquoter for compile-time input validation and running arbitrary IO at compile time.
categories:
 - haskell
tags:
 - template-haskell
